...
# Case 2: Two file systems mounted under same root dir.  # 0. Start two fs with same rootdir
...
writeone($dir1, $f1, 100);
checkcontent($dir1, $f1);
print "OK\n";

print "Write into middle of file from other server ";
writeat($dir2, $f1, 100);
print "OK\n";



print "alternate appends 10000 bytes between two clients 25 times each: ";
append($dir1, $f1, 100000);
append($dir2, $f1, 100000);
append($dir1, $f1, 100000);
append($dir2, $f1, 100000);
append($dir1, $f1, 100000);
append($dir2, $f1, 100000);
